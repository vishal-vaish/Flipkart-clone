...
const Signup = () => {
  ...
  return (
    <>
      <HStack>
        <Button variant="link" ref={btnRef} color='white' colorScheme='teal' onClick={onOpen}> <MdAccountCircle size={25} />
        </Button>
      </HStack>
      ...
      >
        ...
        <DrawerContent>
          <DrawerCloseButton />
          <Image margin="auto" mt={5} borderRadius='full' border="2px solid #f58014" boxSize="120px" src='https://www.freepnglogos.com/uploads/flipkart-logo-png/flipkart-finger-print-biometrics-aadhaar-ekyc-access-control-17.png' />
